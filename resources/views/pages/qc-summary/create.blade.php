    ...
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-lg">
                <div class="p-6">
                    <form action="{{ route('qc-summary.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <select name="process" id="process"
                                ...
                                <option value="hanging" {{ old('process') == 'hanging' ? 'selected' : '' }}>Hanging</option>
                                <option value="buttoning" {{ old('process') == 'buttoning' ? 'selected' : '' }}>Buttoning</option>
                                <option value="plating" {{ old('process') == 'plating' ? 'selected' : '' }}>Plating</option>
                                <option value="steaming" {{ old('process') == 'steaming' ? 'selected' : '' }}>Steaming</option>
                                <option value="thread_trimming" {{ old('process') == 'thread_trimming' ? 'selected' : '' }}>Thread Trimming</option>
                            </select>
                            @error('process')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
