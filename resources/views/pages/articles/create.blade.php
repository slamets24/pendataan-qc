                ...
                <div class="p-6">
                    <form action="{{ route('articles.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="article_name" id="article_name" value="{{ old('article_name') }}"
                                   class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                   required>
                            @error('article_name')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="date" name="created_date" id="created_date" value="{{ old('created_date', date('Y-m-d')) }}"
                                   class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                   required>
                            @error('created_date')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
