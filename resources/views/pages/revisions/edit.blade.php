    ...
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-lg">
                <div class="p-6">
                    <form action="{{ route('revisions.update', $revision) }}" method="POST" x-data="revisionForm()">
                        @csrf
                        @method('PUT')
    ...
    <script>
        function revisionForm() {
            return {
                ...
                selectedArticle: '{{ old('article_id', $revision->article_id) }}',
                selectedBrand: '{{ old('brand_id', $revision->brand_id) }}',
                selectedBrandName: '',
